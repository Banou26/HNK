import { walkPlaceholders, getNodePath } from './utils'
import { placeholderMinRangeChar, placeholderMaxRangeChar, placeholderRegex, placeholder as toPlaceholder, charToN, toPlaceholderString } from '../utils'
